    ...
    return (
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex-1 min-w-0">
          <h3 className="font-sans font-bold text-[#253A4A] text-base mb-1">{label}</h3>
          <p className="font-sans text-sm text-[#5C7E9A] leading-relaxed">{description}</p>
        </div>
        <div className="flex items-center gap-4 flex-shrink-0 mt-2 sm:mt-0">
          ...
          <button
            ...
            className={`w-14 h-8 rounded-full flex items-center transition-colors px-1 shadow-inner focus:outline-none focus:ring-2 focus:ring-offset-2 ${
              isOn ? (danger ? 'bg-red-500 focus:ring-red-500' : 'bg-[#253A4A] focus:ring-[#253A4A]') : 'bg-gray-200 focus:ring-gray-300'
            }`}
          >
    ...
    <div className="space-y-8 sm:space-y-12 pb-24 max-w-4xl mx-auto">
      <BlurReveal>
        <div className="mb-6 sm:mb-8 px-4 sm:px-0">
          <h1 className="font-serif text-3xl sm:text-4xl text-[#253A4A] tracking-tight mb-4 flex items-center gap-3">
            <Settings className="w-6 h-6 sm:w-8 sm:h-8 text-[#5C7E9A]" />
            Platform Settings
          </h1>
          <p className="font-sans text-sm sm:text-base text-[#5C7E9A] leading-relaxed max-w-2xl">
      ...
      <Fade delay={0.1}>
        <div className="bg-white/60 backdrop-blur-[24px] rounded-2xl sm:rounded-3xl border border-white/40 shadow-[0_8px_30px_rgba(37,58,74,0.04)] overflow-hidden mx-4 sm:mx-0">
          <div className="p-6 sm:p-8 border-b border-[#253A4A]/5 flex items-center gap-3 text-[#253A4A] bg-white/40">
      ...
      <Fade delay={0.2}>
        <div className="bg-white/60 backdrop-blur-[24px] rounded-2xl sm:rounded-3xl border border-white/40 shadow-[0_8px_30px_rgba(37,58,74,0.04)] overflow-hidden mx-4 sm:mx-0">
          <div className="p-6 sm:p-8 border-b border-[#253A4A]/5 flex items-center gap-3 text-[#253A4A] bg-white/40">
            <Database className="w-5 h-5 text-[#5C7E9A]" />
          ...
          <div className="p-6 sm:p-8 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex-1 min-w-0">
                <h3 className="font-sans font-bold text-[#253A4A] text-base mb-1">Default Daily Analysis Limit</h3>
                <p className="font-sans text-sm text-[#5C7E9A] leading-relaxed">Default number of analyses a new user can perform daily.</p>
              </div>
              <div className="mt-2 sm:mt-0 flex-shrink-0">
                <input
                  ...
                  className="w-24 bg-white border border-[#253A4A]/10 rounded-xl px-4 py-2 text-sm text-center font-bold text-[#253A4A] focus:outline-none focus:border-[#253A4A]/30 focus:ring-2 focus:ring-[#253A4A]/10 transition-all shadow-sm"
                />
              </div>
            </div>
      ...
      <Fade delay={0.3}>
        <div className="bg-white/60 backdrop-blur-[24px] rounded-2xl sm:rounded-3xl border border-white/40 shadow-[0_8px_30px_rgba(37,58,74,0.04)] overflow-hidden mx-4 sm:mx-0">
          <div className="p-6 sm:p-8 border-b border-[#253A4A]/5 flex items-center gap-3 text-[#253A4A] bg-white/40">
            <Download className="w-5 h-5 text-[#5C7E9A]" />
            <h2 className="font-sans font-bold uppercase tracking-widest text-xs sm:text-sm">Database Actions</h2>
          </div>
          <div className="p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
              <div className="flex-1">
                <h3 className="font-sans font-bold text-[#253A4A] text-base mb-1">Export Database V2</h3>
                <p className="font-sans text-sm text-[#5C7E9A] leading-relaxed">Download a full JSON snapshot of the database. Requires export to be enabled.</p>
              </div>
              <Button
      ...
      {/* Sticky Save Bar */}
      <div className="fixed sm:sticky bottom-0 left-0 right-0 sm:left-auto sm:right-auto bg-white/80 backdrop-blur-xl sm:bg-[#FCFBF8]/95 sm:backdrop-blur-sm border-t border-[#253A4A]/5 py-4 px-6 sm:px-8 sm:-mx-8 flex items-center justify-between z-40 pb-[max(1rem,env(safe-area-inset-bottom))]">
        <span className="hidden sm:inline-block">
          ...
          {(saveStatus === 'idle' || saveStatus === 'saving') && (
            <span className="text-[#5C7E9A] text-xs font-medium tracking-wide">Changes will apply globally.</span>
          )}
        </span>
